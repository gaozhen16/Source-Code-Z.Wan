function [H_uplink, A_BS, A_MS, alpha, ele_MS, azi_MS, ele_BS, azi_BS] = mmWave_uplink_channel_FDLens(D_MS, D_BS, ele_max_MS, azi_max_MS, ele_max_BS, azi_max_BS, Lp, flag_pure)
if(flag_pure)
