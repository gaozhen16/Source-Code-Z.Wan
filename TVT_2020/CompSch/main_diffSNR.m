...
%         toc
        disp(['  MYsche, overhead = ' num2str(N_MS_beam) ', SNR = ' num2str(PNR_dBs(i_PNR_dB)) ', iter_max = ' num2str(iterMax) ', iter_now = ' num2str(iter) ...
...
toc
% closematlabpool
NMSE_dB = 10*log10(NMSE);k
disp('Finished all');
if(save_flag)
    save NMSE_R80_8w NMSE_dB
end
%% Plot
figure
