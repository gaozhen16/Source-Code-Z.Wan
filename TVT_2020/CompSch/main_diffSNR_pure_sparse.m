...
%     tic
    ...
    for iter = 1:iterMax
%         tic
        [H_up,~,A_MS,~,ele_MS, azi_MS] = mmWave_uplink_channel_FDLens(D_MS, D_BS, ele_max_MS, azi_max_MS, ele_max_BS, azi_max_BS, Lp, 1, G_MS_r);
...
%         toc
        disp(['  pure sparse, overhead = ' num2str(N_MS_beam) ', SNR = ' num2str(PNR_dBs(i_PNR_dB)) ', iter_max = ' num2str(iterMax) ', iter_now = ' num2str(iter) ...
