...
N_MS_beam = 48; %N_beam须同时为N_RF和N_block的倍数
...
for i_PNR_dB = 1:length(PNR_dBs)
    ...
    for iter = 1:iterMax
        ...
        toc
        disp(['  MTC, overhead = ' num2str(N_MS_beam) ', SNR = ' num2str(PNR_dBs(i_PNR_dB)) ', iter_max = ' num2str(iterMax) ', iter_now = ' num2str(iter) ', OMP_iter = ' num2str(iter_num) ...
...
if(save_flag)
    switch N_MS_beam
        case 16
            save NMSE_MTC_o16_m15tom10_L6 NMSE_dB
        case 32
            save NMSE_MTC_o32_m15tom10_L6 NMSE_dB
        case 48
            save NMSE_MTC_o48_m15tom10_L6 NMSE_dB
    end
end
%% Plot
% figure
